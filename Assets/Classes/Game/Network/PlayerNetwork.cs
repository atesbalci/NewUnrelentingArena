...
namespace Game.Network
{
    public class PlayerNetwork : GameNetworker
    {
        ...
        //Sync stats
        [SyncVar(hook = "SyncHealth")] private float _health;

        [SyncVar(hook = "SyncEnergy")] private float _energy;

        //Sync transform data
        [SyncVar] private Quaternion _rotation;

        [SyncVar] private Vector2 _movementDirection;
        ...
        {
            get { return Script.Model as Player; }
        }

        public PlayerScript PlayerScript
        {
            get { return Script as PlayerScript; }
        }
        ...
        public override void Start()
        {
            ...
            if (isLocalPlayer)
            {
                Player.Health.Subscribe(val => { _health = val; });
                Player.Energy.Subscribe(val => { _energy = val; });
            }
        }
